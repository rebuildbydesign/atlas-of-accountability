...
`;
    ...
    document.getElementById('shareReportButton').addEventListener('click', function() {
        ...
        const body = encodeURIComponent(
            'Hello,\n\nI believe you will be interested in this. Rebuild by Design launched Atlas of Accountability, an interactive map that showcases county-level federally declared disasters and congressional districts between 2011-2023. 91% of U.S. counties have experienced a federal climate disaster during this period, with some counties experiencing up to 15 disasters, totaling $106.4 billion in federal funding.\n\nhttps://rebuildbydesign.org/atlas-of-disaster\n\nThis map highlights the urgent need for bipartisan collaboration. The report also outlines strategies for shifting from post-disaster funding to pre-disaster preparedness.\n\nPlease share this with your network to help spread awareness and advocate for stronger, resilient infrastructure.'
        );
